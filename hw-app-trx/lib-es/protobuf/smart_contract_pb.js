...
SmartContract.ABI.Entry.prototype.getInputsList = function () {
    return /** @type{!Array<!SmartContract.ABI.Entry.Param>} */ (jspb.Message.getRepeatedWrapperField(this, SmartContract.ABI.Entry.Param, 4));
};
/**
...
SmartContract.ABI.Entry.prototype.getOutputsList = function () {
    return /** @type{!Array<!SmartContract.ABI.Entry.Param>} */ (jspb.Message.getRepeatedWrapperField(this, SmartContract.ABI.Entry.Param, 5));
};
/**
 * @param {!Array<!SmartContract.ABI.Entry.Param>} value
 * @return {!SmartContract.ABI.Entry} returns this
...
SmartContract.ABI.prototype.getEntrysList = function () {
    return /** @type{!Array<!SmartContract.ABI.Entry>} */ (jspb.Message.getRepeatedWrapperField(this, SmartContract.ABI.Entry, 1));
};
/**
...
SmartContract.prototype.getAbi = function () {
    return /** @type{?SmartContract.ABI} */ (jspb.Message.getWrapperField(this, SmartContract.ABI, 3));
};
/**
...
CreateSmartContract.prototype.getNewContract = function () {
    return /** @type{?SmartContract} */ (jspb.Message.getWrapperField(this, SmartContract, 2));
};
/**
...
SmartContractDataWrapper.prototype.getSmartContract = function () {
    return /** @type{?SmartContract} */ (jspb.Message.getWrapperField(this, SmartContract, 1));
};
/**
 * @param {?SmartContract|undefined} value
